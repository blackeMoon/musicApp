<template>
    <div>
        ...
        <div class="player" v-if="showplayer">
            ...
            <div class="range">
                <div class="bar">
                    <span class="timeLeft">{{timeLeft | plagerTime}}</span>
                    <van-slider v-model="value" bar-height="4px" active-color="#ee0a24" @change="seliderchange">
                        <template #button>
                            <div class="custom-button"></div>
                        </template>
                    </van-slider>
                    <span class="timeRight">{{timeRight | plagerTime}}</span>
                </div>
            </div>

            <div class="buttons">
                <div  v-if="playerType == 1" class="iconfont icon-liebiaoxunhuan" @click="changeMode"></div>
                <div v-else class="iconfont icon-random" @click="changeMode"></div>
                <div @click="startup" class="iconfont icon-1_music83" ></div>
                <div :class="['iconfont',iconplay?'icon-play-circle':'icon-timeout','center']" @click.stop="toggleplay"></div>
                <div @click="lowerFun" class="iconfont icon-1_music82"></div>
        ...
        <div class="mini-player">
            ...
            <div class="control" @click.stop="toggleplay">
                <span class="iconfont icon-play-circle" v-show="iconplay" ></span>
                <span class="iconfont icon-timeout" v-show="!iconplay"></span>
            </div>
        ...
        <div class="musicPlayList" v-if="isMusicPlayList">
            ...
            <div class="dt">
                <h1><i class="iconfont icon-liebiaoxunhuan"></i>顺序播放({{playerLists.length}})</h1>
        ...
        <audio ref="audio" controls  :src="musicData" @ended="endedFun" @canplay="canplayFun"></audio>
    </div>
</template>
    ...
    export default {
        ...
        methods:{
            ...
            canplayFun(){
                ...
                this.timeRight = duration; //右侧歌的时间
            },
            // 获取滚动条变化
            seliderchange(){
        ...
        watch:{
            ...
            listId(){
                console.log("播放歌单音乐",this.listId)
